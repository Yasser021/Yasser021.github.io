    ...
    <div className="bg-black py-14 text-white">
      <section className="flex items-center py-5">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/2 flex flex-col items-start md:items-start text-left p-5">
          ...
          <div className="h-64 border-l-4 border-gray-300 mx-5"></div>
          <div className="flex flex-col items-start">
            <div className="flex justify-between">
              ...
              <div className="">
                <h1 className="text-3xl font-bold mb-2">Phone Number</h1>
                <div className="border-b-4 border-white w-72 mb-3"></div>
